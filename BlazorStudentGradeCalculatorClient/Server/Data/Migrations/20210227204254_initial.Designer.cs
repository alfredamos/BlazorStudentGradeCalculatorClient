...
namespace BlazorStudentGradeCalculatorClient.Server.Data.Migrations
{
    ...
    [Migration("20210227204254_initial")]
            ...
            modelBuilder.Entity("BlazorStudentGradeCalculatorClient.Shared.Models.Examm", b =>
                {
                    ...
                    b.Property<int>("StudentExammsID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorStudentGradeCalculatorClient.Shared.Models.MidTerm", b =>
                {
                    ...
                    b.Property<int>("StudentMidTermID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorStudentGradeCalculatorClient.Shared.Models.Score", b =>
                {
                    ...
                    b.Property<int>("ExammsScoreID")
                        .HasColumnType("int");

                    b.Property<int>("HomeWorkScoreID")
                        .HasColumnType("int");

                    b.Property<int>("MidTermScoreID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ExammsScoreID")
                        .IsUnique();

                    b.HasIndex("HomeWorkScoreID");

                    b.HasIndex("MidTermScoreID")
                        .IsUnique();
            ...
            modelBuilder.Entity("BlazorStudentGradeCalculatorClient.Shared.Models.Examm", b =>
                {
                    b.HasOne("BlazorStudentGradeCalculatorClient.Shared.Models.Student", "Student")
                        .WithOne("Examm")
                        .HasForeignKey("BlazorStudentGradeCalculatorClient.Shared.Models.Examm", "StudentExammsID")
            ...
            modelBuilder.Entity("BlazorStudentGradeCalculatorClient.Shared.Models.HomeWork", b =>
                {
                    b.HasOne("BlazorStudentGradeCalculatorClient.Shared.Models.Student", "Student")
                        .WithOne("HomeWork")
                        .HasForeignKey("BlazorStudentGradeCalculatorClient.Shared.Models.HomeWork", "StudentHomeWorkID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BlazorStudentGradeCalculatorClient.Shared.Models.MidTerm", b =>
                {
                    b.HasOne("BlazorStudentGradeCalculatorClient.Shared.Models.Student", "Student")
                        .WithOne("MidTerm")
                        .HasForeignKey("BlazorStudentGradeCalculatorClient.Shared.Models.MidTerm", "StudentMidTermID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BlazorStudentGradeCalculatorClient.Shared.Models.Score", b =>
                {
                    b.HasOne("BlazorStudentGradeCalculatorClient.Shared.Models.Examm", "Examm")
                        .WithOne("Score")
                        .HasForeignKey("BlazorStudentGradeCalculatorClient.Shared.Models.Score", "ExammsScoreID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("BlazorStudentGradeCalculatorClient.Shared.Models.MidTerm", "MidTerm")
                        .WithOne("Score")
                        .HasForeignKey("BlazorStudentGradeCalculatorClient.Shared.Models.Score", "MidTermScoreID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
